    ...
    <div className="bg-gray-50 min-h-screen py-12">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-800 mb-4">BetterHelp vs Cerebral: Which Is Better in 2025?</h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
            A detailed comparison of BetterHelp's therapy-only approach with Cerebral's combined therapy and medication management services.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-gray-50 rounded-lg p-6">
              ...
              <p className="text-gray-600 mb-4">
                The world's largest online therapy platform, focusing exclusively on counseling services.
              </p>
            ...
            <div className="bg-indigo-50 rounded-lg p-6">
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <span>BetterHelp focuses on therapy only, while Cerebral offers combined care</span>
                </li>
                <li className="flex items-start">
                  <Shield className="h-5 w-5 text-indigo-600 mr-2 mt-0.5" />
                  <span>Cerebral accepts insurance, BetterHelp doesn't</span>
                </li>
                <li className="flex items-start">
                ...
                <li className="flex items-start">
                  ...
                  <span>Cerebral has higher costs for medication plans</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-gray-50 rounded-lg p-6">
              ...
              <p className="text-gray-600 mb-4">
                Combined therapy and medication management platform with comprehensive care options.
              </p>
              <ul className="space-y-2 mb-4">
                <li className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-green-500 mr-2 mt-0.5" />
        ...
        <div className="bg-white rounded-lg shadow-md p-8 mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-gray-50 rounded-lg p-6">
                ...
                <ul className="space-y-2">
                  ...
                  <li className="flex items-start">
                    <XCircle className="h-5 w-5 text-red-500 mr-2 mt-0.5" />
                    <span>No medication services</span>
                  </li>
                </ul>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                ...
                <ul className="space-y-2">
                  ...
                  <li className="flex items-start">
                    <XCircle className="h-5 w-5 text-red-500 mr-2 mt-0.5" />
                    <span>Higher costs for medication plans</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-gray-50 rounded-lg p-6">
                ...
                <ul className="space-y-2">
                  ...
                  <li className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-green-500 mr-2 mt-0.5" />
                    <span>Diverse specializations</span>
                  </li>
                  <li className="flex items-start">
                    <XCircle className="h-5 w-5 text-red-500 mr-2 mt-0.5" />
                    <span>No psychiatrists</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                ...
                <ul className="space-y-2">
                  <li className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-green-500 mr-2 mt-0.5" />
                    <span>Licensed therapists and prescribers</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-green-500 mr-2 mt-0.5" />
                    <span>Psychiatric providers available</span>
                  </li>
                  <li className="flex items-start">
                    <XCircle className="h-5 w-5 text-red-500 mr-2 mt-0.5" />
                    <span>Smaller provider network</span>
          ...
          <div className="bg-indigo-50 rounded-lg p-6">
            ...
            <ul className="space-y-2 mb-4">
              <li className="flex items-start">
                <CheckCircle className="h-5 w-5 text-green-500 mr-2 mt-0.5" />
                <span>You're looking for therapy-only services</span>
              </li>
              <li className="flex items-start">
                <CheckCircle className="h-5 w-5 text-green-500 mr-2 mt-0.5" />
                <span>You want more therapist options</span>
              </li>
              <li className="flex items-start">
                <CheckCircle className="h-5 w-5 text-green-500 mr-2 mt-0.5" />
                <span>You prefer unlimited messaging</span>
              </li>
            </ul>
            <p className="text-gray-700 mb-4">
            ...
            <ul className="space-y-2">
              <li className="flex items-start">
                <CheckCircle className="h-5 w-5 text-green-500 mr-2 mt-0.5" />
                <span>You need both therapy and medication</span>
              </li>
              <li className="flex items-start">
                <CheckCircle className="h-5 w-5 text-green-500 mr-2 mt-0.5" />
                <span>You want to use insurance</span>
              </li>
              <li className="flex items-start">
                <CheckCircle className="h-5 w-5 text-green-500 mr-2 mt-0.5" />
                <span>You prefer an integrated care approach</span>
              </li>
            </ul>
          </div>
        </div>
...
export default BetterHelpVsCerebral;