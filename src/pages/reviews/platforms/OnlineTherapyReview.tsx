              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    ...
                    <li className="flex items-start">
                      <XCircle className="h-5 w-5 text-red-500 mr-2 mt-0.5" />
                      <span>Less suitable for complex conditions</span>
                    </li>
                  </ul>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="flex">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Daily feedback + live sessions</p>
              </div>
            </div>
            ...
            <div className="flex">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">Focused CBT approach</p>
              </div>
            </div>
