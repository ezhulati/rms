...
const SpecializedPlatformsPage = () => {
  ...
  const platforms = [
    {
      ...
      image: '/images/concepts/specializedplatformspage.jpg',
      rating: 4.5,
      price: '$60-$90/week',
    ...
    <div className="bg-gray-50 min-h-screen py-12">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-800 mb-4">Specialized Online Therapy Platforms</h1>
...
export default SpecializedPlatformsPage;