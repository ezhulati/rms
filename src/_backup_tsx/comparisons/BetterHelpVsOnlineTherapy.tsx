...
const BetterHelpVsOnlineTherapy = () => {
    ...
    <div className="bg-gray-50 min-h-screen py-12">
      <div className="container mx-auto px-4">
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden mb-8">
          <div className="p-8">
            <h1 className="text-3xl font-bold text-gray-800 mb-4">BetterHelp vs Online-Therapy.com: Which Is Right for You in 2025?</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
              Compare BetterHelp's comprehensive platform with Online-Therapy.com's specialized CBT approach to find your ideal therapy match.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-gray-50 rounded-lg p-6">
                ...
                <p className="text-gray-600 mb-4">
                  World's largest online therapy platform with multiple therapy approaches and communication methods.
                </p>
                <Button 
                  as="a"
                ...
                <tr className="border-b hover:bg-gray-50">
                  ...
                  <td className="py-3 px-4">
                    <div className="flex items-center">
                      ...
                      <span className="text-sm text-gray-600">Neither accepts insurance</span>
                    </div>
                  </td>
                </tr>
        ...
        <div className="bg-white rounded-lg shadow-md p-8 mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-gray-50 rounded-lg p-6">
                ...
                <ul className="space-y-2">
                  ...
                  <li className="flex items-start">
                    ...
                    <span>Less structured approach</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                ...
                <ul className="space-y-2">
                  ...
                  <li className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-green-500 mr-2 mt-0.5" />
                    <span>Structured 8-section program</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-green-500 mr-2 mt-0.5" />
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-gray-600">$60-$90/week (billed monthly at $240-$360)</p>
                  </div>
                  <div>
                    <h5 className="font-bold text-gray-800">What's Included</h5>
                    <ul className="space-y-1 text-gray-600">
                      <li>• Unlimited messaging with therapist</li>
                      <li>• Weekly live session (video, phone, or chat)</li>
                      <li>• Worksheets and journaling tools</li>
                      <li>• Groupinars (group webinars)</li>
                    </ul>
                  </div>
                  <div>
                    <h5 className="font-bold text-gray-800">Financial Aid</h5>
                    <p className="text-gray-600">Available (up to 40% discount)</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-gray-600">$40/week - CBT program access only</p>
                  </div>
                  <div>
                    <h5 className="font-bold text-gray-800">Standard Plan</h5>
                  ...
                  <div>
                    <h5 className="font-bold text-gray-800">Discounts</h5>
                    <p className="text-gray-600">20% off first month</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-gray-50 rounded-lg p-6">
                ...
                <ul className="space-y-2">
                  ...
                  <li className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-green-500 mr-2 mt-0.5" />
                    <span>Group webinars on various topics</span>
                  </li>
                  <li className="flex items-start">
                    <XCircle className="h-5 w-5 text-red-500 mr-2 mt-0.5" />
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                ...
                <ul className="space-y-2">
                  ...
                  <li className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-green-500 mr-2 mt-0.5" />
                    <span>Structured 8-section CBT program</span>
                  </li>
                  <li className="flex items-start">
                    <XCircle className="h-5 w-5 text-red-500 mr-2 mt-0.5" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-gray-50 rounded-lg p-6">
                ...
                <ul className="space-y-2">
                  ...
                  <li className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-green-500 mr-2 mt-0.5" />
                    <span>Excellent mobile app</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-green-500 mr-2 mt-0.5" />
                    <span>Quick therapist matching</span>
                  </li>
                  <li className="flex items-start">
                    <XCircle className="h-5 w-5 text-red-500 mr-2 mt-0.5" />
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                ...
                <ul className="space-y-2">
                  <li className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-green-500 mr-2 mt-0.5" />
                    <span>Clean, organized interface</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-green-500 mr-2 mt-0.5" />
                  ...
                  <li className="flex items-start">
                    <XCircle className="h-5 w-5 text-red-500 mr-2 mt-0.5" />
                    <span>Limited mobile experience</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="bg-indigo-50 rounded-lg p-6">
            ...
            <ul className="space-y-2 mb-4">
              <li className="flex items-start">
                <CheckCircle className="h-5 w-5 text-green-500 mr-2 mt-0.5" />
                <span>You want flexibility in therapy approaches</span>
              </li>
              <li className="flex items-start">
                <CheckCircle className="h-5 w-5 text-green-500 mr-2 mt-0.5" />
                <span>You prefer multiple communication options</span>
              </li>
              <li className="flex items-start">
                <CheckCircle className="h-5 w-5 text-green-500 mr-2 mt-0.5" />
                <span>You value a large therapist selection</span>
              </li>
              <li className="flex items-start">
                <CheckCircle className="h-5 w-5 text-green-500 mr-2 mt-0.5" />
                <span>You need financial aid options</span>
              </li>
            </ul>
            <p className="text-gray-700 mb-4">
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-start">
                <CheckCircle className="h-5 w-5 text-green-500 mr-2 mt-0.5" />
                <span>You prefer a structured therapy program</span>
              </li>
              <li className="flex items-start">
                <CheckCircle className="h-5 w-5 text-green-500 mr-2 mt-0.5" />
                <span>You want a more affordable basic option</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <Link to="/compare/platforms/talkspace-vs-online-therapy" className="bg-gray-50 rounded-lg p-4 hover:bg-gray-100 transition">
              ...
              <p className="text-gray-600 text-sm">Compare insurance coverage with specialized CBT approach.</p>
            </Link>
            <Link to="/compare/platforms/betterhelp-vs-calmerry" className="bg-gray-50 rounded-lg p-4 hover:bg-gray-100 transition">
              ...
              <p className="text-gray-600 text-sm">Compare BetterHelp with a more affordable alternative.</p>
            </Link>
          </div>
        </div>
      </div>
...
export default BetterHelpVsOnlineTherapy;
