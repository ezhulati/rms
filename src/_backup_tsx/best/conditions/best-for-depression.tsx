...
import { Star, CheckCircle, XCircle, ArrowRight, ExternalLink, MessageSquare, Video, Phone, Search, Brain, Shield, Users } from 'lucide-react';
  ...
  const platforms = [
    ...
    },
    {
      ...
      cons: [
        ...
        'Response times vary',
        'Higher cost without financial aid'
      ]
    },
    {
      name: 'Brightside',
        ...
        <div className="bg-white rounded-lg shadow-md p-8 mb-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-indigo-50 rounded-lg p-6 relative">
              ...
              <p className="text-gray-600 mb-4">
                Wide range of therapeutic approaches for depression with financial aid options.
              </p>
              <div className="text-sm text-gray-600 mb-4">
