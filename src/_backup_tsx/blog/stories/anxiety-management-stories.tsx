...
import { ArrowRight, Calendar, User, Tag, MessageCircle, Clock, Heart, Brain, CheckCircle, Activity } from 'lucide-react';
import BlogLayout from '../BlogLayout';

const AnxietyManagementStories = () => {
  return (
    <BlogLayout>
      {/* Breadcrumb */}
      <div className="flex items-center text-sm text-gray-500 mb-6">
        ...
        <span className="mx-2">/</span>
        <span className="text-gray-700">Living with Anxiety</span>
      </div>

      {/* Article Header */}
      <div className="bg-white rounded-lg shadow-md overflow-hidden mb-8">
        <img
          src="/images/blog/anxiety-management-stories.jpg"
          alt="Living with Anxiety"
          className="blog-featured-image h-96"
        />
        <div className="p-8">
          <h1 className="blog-title">Living with Anxiety: Personal Strategies That Help Me Cope</h1>
          ...
          <div className="flex flex-wrap items-center text-sm text-gray-500 mb-6">
            ...
            <div className="flex items-center mr-6 mb-2 sm:mb-0">
              ...
              <span>By Emma Rodriguez, Mental Health Writer</span>
            </div>
            <div className="flex items-center mr-6 mb-2 sm:mb-0">
              <Tag className="h-4 w-4 mr-1" />
              <Link to="/blog/tag/anxiety" className="hover:text-indigo-600">Anxiety</Link>,{" "}
              <Link to="/blog/tag/coping-strategies" className="hover:text-indigo-600 ml-1">Coping Strategies</Link>
            </div>
            <div className="flex items-center mr-6 mb-2 sm:mb-0">
          ...
          <div className="bg-indigo-50 rounded-lg p-4 mb-6">
            <p className="text-gray-700 italic">
              "Anxiety doesn't disappear completely, but with the right tools and strategies, it becomes manageable. These four individuals prove that you can build a fulfilling life alongside anxiety, not in spite of it." — Emma Rodriguez, Mental Health Writer
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-md p-8 mb-8">
        <div className="blog-content">
          <p>
            Anxiety disorders affect nearly 40 million adults in the United States alone. Behind those statistics are millions of individual stories—people who wake up each day and navigate a world that can feel overwhelming, uncertain, or threatening in ways others might not fully understand.
          </p>

          <p>
            But alongside those challenges are stories of resilience, adaptation, and the creative strategies people develop to manage their anxiety. I spoke with four individuals living with different anxiety disorders about the daily practices, tools, and techniques that help them not just survive, but thrive.
          </p>

          <h2 className="blog-subtitle">Mia's Story: Generalized Anxiety Disorder and the Power of Routine</h2>
          <p>
          ...
          <h3 className="blog-subheading">What Helps: Structured Routines</h3>
          <p>
          ...
          <h3 className="blog-subheading">The Physical Component</h3>
          <p>
          ...
          <h3 className="blog-subheading">What She Wishes Others Knew</h3>
          <p>
          ...
          <div className="blog-callout">
            <h3 className="blog-subheading"><CheckCircle className="h-5 w-5 inline mr-2" />Mia's Key Strategies</h3>
            <ul className="list-disc pl-5 space-y-2">
              <li>Consistent morning routine with yoga and journaling</li>
              <li>Scheduled "worry time" to contain anxious thoughts</li>
              <li>Regular aerobic exercise as anxiety management</li>
              <li>Progressive muscle relaxation when physical tension arises</li>
              <li>Time-blocking and structure in daily schedule</li>
            </ul>
          </div>

          <h2 className="blog-subtitle">David's Story: Social Anxiety and Gradual Exposure</h2>
          <p>
          ...
          <h3 className="blog-subheading">What Helps: The Exposure Ladder</h3>
          <p>
          ...
          <h3 className="blog-subheading">Managing Performance Anxiety</h3>
          <p>
          ...
          <h3 className="blog-subheading">Current Life</h3>
          <p>
          ...
          <div className="blog-callout">
            <h3 className="blog-subheading"><Activity className="h-5 w-5 inline mr-2" />David's Key Strategies</h3>
            <ul className="list-disc pl-5 space-y-2">
              <li>Systematic exposure therapy using an anxiety hierarchy</li>
              <li>Gradual, consistent practice of feared situations</li>
              <li>"Spotlight effect" cognitive reframing</li>
              <li>Self-compassion instead of self-criticism</li>
              <li>Celebrating small wins and progress</li>
            </ul>
          </div>

          <h2 className="blog-subtitle">Priya's Story: Panic Disorder and Embodied Coping</h2>
          <p>
          ...
          <h3 className="blog-subheading">Understanding Panic</h3>
          <p>
          ...
          <h3 className="blog-subheading">What Helps: Body-Based Techniques</h3>
          <p>
          ...
          <h3 className="blog-subheading">Lifestyle Factors</h3>
          <p>
          ...
          <h3 className="blog-subheading">Building a Support System</h3>
          <p>
          ...
          <h3 className="blog-subheading">Progress Over Perfection</h3>
          <p>
          ...
          <div className="blog-callout">
            <h3 className="blog-subheading"><Heart className="h-5 w-5 inline mr-2" />Priya's Key Strategies</h3>
            <ul className="list-disc pl-5 space-y-2">
              <li>Tactical breathing (box breathing) during panic onset</li>
              <li>5-4-3-2-1 sensory grounding technique</li>
              <li>Eliminating caffeine and reducing alcohol</li>
              <li>Prioritizing consistent sleep schedule</li>
              <li>Open communication with support system</li>
              <li>Reframing panic attacks as temporary, not dangerous</li>
            </ul>
          </div>

          <h2 className="blog-subtitle">Alex's Story: Health Anxiety and Cognitive Restructuring</h2>
          <p>
          ...
          <h3 className="blog-subheading">The Anxiety Spiral</h3>
          <p>
          ...
          <h3 className="blog-subheading">What Helps: Thought Records</h3>
          <p>
          ...
          <h3 className="blog-subheading">Reducing Reassurance-Seeking</h3>
          <p>
          ...
          <h3 className="blog-subheading">Mindfulness and Acceptance</h3>
          <p>
          ...
          <h3 className="blog-subheading">Living with Uncertainty</h3>
          <p>
          ...
          <div className="blog-callout">
            <h3 className="blog-subheading"><Brain className="h-5 w-5 inline mr-2" />Alex's Key Strategies</h3>
            <ul className="list-disc pl-5 space-y-2">
              <li>Thought records to challenge catastrophic thinking</li>
              <li>Limiting reassurance-seeking behaviors</li>
              <li>Building tolerance for uncertainty</li>
              <li>Mindful observation of bodily sensations without judgment</li>
              <li>Setting boundaries around medical googling and doctor visits</li>
            </ul>
          </div>

          <h2 className="blog-subtitle">Common Threads: What Works Across Anxiety Types</h2>
          <p>
            While each person's anxiety manifests differently and requires personalized strategies, several themes emerge:
          </p>

          <h3 className="blog-subheading">1. Knowledge is Power</h3>
          <p>
            All four individuals emphasized that understanding their specific anxiety disorder—its physiology, triggers, and typical patterns—reduced fear and enabled more effective management.
          </p>

          <h3 className="blog-subheading">2. Consistency Matters More Than Perfection</h3>
          <p>
            None of these individuals have "cured" their anxiety. They have built practices that, done consistently, keep anxiety manageable. Some days are harder than others, and that's okay.
          </p>

          <h3 className="blog-subheading">3. Avoidance Feeds Anxiety</h3>
          <p>
          ...
          <h3 className="blog-subheading">4. The Body Matters</h3>
          <p>
          ...
          <h3 className="blog-subheading">5. Self-Compassion Accelerates Healing</h3>
          <p>
          ...
          <h3 className="blog-subheading">6. Support Systems Are Essential</h3>
          <p>
      ...
      <div className="blog-author">
        ...
        <div>
          ...
          <p className="blog-author-bio">
            Emma Rodriguez is a mental health writer who specializes in translating research and lived experience into accessible, practical information. Having navigated her own anxiety journey, she's passionate about destigmatizing mental health challenges and highlighting the strategies that help people thrive.
          </p>
          <div className="flex items-center">
            <Link to="/blog/author/emma-rodriguez" className="text-indigo-600 hover:text-indigo-800 mr-4">
              More from Emma
            </Link>
            <a href="https://twitter.com/emmarodriguez" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-600">
              @emmarodriguez
            </a>
          </div>
        </div>
      ...
      <div className="blog-comments">
        <div className="flex items-center justify-between mb-6">
          <h3 className="text-xl font-bold text-gray-800">Comments (19)</h3>
        ...
        <div className="space-y-6">
            ...
            <div className="flex items-start mb-4">
              ...
              <div>
                <div className="flex items-center mb-1">
                  <h4 className="font-bold text-gray-800 mr-2">Jessica Chen</h4>
                  <span className="text-gray-500 text-sm">2 days ago</span>
                </div>
                <p className="text-gray-700">
                  David's story really hit home. I also have social anxiety and the exposure ladder has been life-changing for me. It's hard and uncomfortable, but it WORKS. Three years ago I couldn't order a coffee; now I'm doing presentations at work. If you're struggling with social anxiety, please don't give up—it can get better!
                </p>
          ...
          <div className="border-b pb-6">
            <div className="flex items-start">
              ...
              <div>
                <div className="flex items-center mb-1">
                  <h4 className="font-bold text-gray-800 mr-2">Michael Torres</h4>
                  <span className="text-gray-500 text-sm">1 day ago</span>
                </div>
                <p className="text-gray-700">
                  The 5-4-3-2-1 grounding technique that Priya mentioned has been a game-changer for my panic attacks. I keep a note in my phone with the steps for when I'm too panicked to remember. Simple, effective, and it actually works to break the panic spiral.
                </p>
                <button className="text-indigo-600 text-sm mt-2 flex items-center bg-indigo-50 px-3 py-1 rounded-md hover:bg-indigo-100 transition-all duration-200">
                  <MessageCircle className="h-3 w-3 mr-1" /> Reply
                </button>
...
export default AnxietyManagementStories;
