        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden mb-8">
          <div className="md:flex">
            ...
            <div className="p-8 md:w-2/3">
              <h1 className="text-3xl font-bold text-gray-800 mb-4">Depression</h1>
              ...
              <div className="flex flex-wrap gap-4">
                <Button 
                  as={Link} 
                  to="/tools/assessments/depression-assessment" 
                  variant="primary"
                  icon={Brain}
                >
        ...
        <div className="bg-white rounded-lg shadow-md p-8 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-gray-50 rounded-lg p-6">
              <h3 className="text-xl font-bold text-gray-800 mb-3">Major Depressive Disorder</h3>
              ...
              <ul className="list-disc pl-5 text-gray-600 space-y-1">
                ...
                <li>Changes in sleep/appetite</li>
            ...
            <div className="bg-gray-50 rounded-lg p-6">
              <h3 className="text-xl font-bold text-gray-800 mb-3">Seasonal Affective Disorder</h3>
              <p className="text-gray-600 mb-4">
            ...
            <div className="bg-gray-50 rounded-lg p-6">
              ...
              <ul className="list-disc pl-5 text-gray-600 space-y-1">
                ...
                <li>Anxiety about parenting</li>
              </ul>
            </div>
            
            <div className="bg-gray-50 rounded-lg p-6">
              <h3 className="text-xl font-bold text-gray-800 mb-3">Atypical Depression</h3>
              <p className="text-gray-600 mb-4">
                A subtype of depression with characteristics that differ from typical depression patterns.
              </p>
              <ul className="list-disc pl-5 text-gray-600 space-y-1">
                <li>Mood reactivity</li>
            ...
            <div className="bg-gray-50 rounded-lg p-6">
              <h3 className="text-xl font-bold text-gray-800 mb-3">Treatment-Resistant Depression</h3>
              <p className="text-gray-600 mb-4">
              ...
              <ul className="list-disc pl-5 text-gray-600 space-y-1">
                ...
                <li>Complex management needs</li>
                <li>Need for alternative approaches</li>
              </ul>
            </div>
          </div>
        </div>
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Helps identify and change negative thought patterns and behaviors associated with depression.</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <div className="bg-indigo-100 rounded-full w-8 h-8 flex items-center justify-center mr-3 mt-1">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-800">Interpersonal Therapy</h4>
                    <p className="text-gray-600">Focuses on improving relationships and communication patterns to reduce depressive symptoms.</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <div className="bg-indigo-100 rounded-full w-8 h-8 flex items-center justify-center mr-3 mt-1">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-800">Psychodynamic Therapy</h4>
                    <p className="text-gray-600">Explores past experiences and unconscious processes that may contribute to depression.</p>
                  </div>
                </li>
              </ul>
            </div>
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Antidepressants and other medications can help manage symptoms when prescribed by a healthcare provider.</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <div className="bg-indigo-100 rounded-full w-8 h-8 flex items-center justify-center mr-3 mt-1">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Regular exercise, improved sleep habits, and stress management techniques can help reduce depressive symptoms.</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <div className="bg-indigo-100 rounded-full w-8 h-8 flex items-center justify-center mr-3 mt-1">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Connecting with others who have similar experiences can provide valuable support and coping strategies.</p>
                  </div>
                </li>
              </ul>
            </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-8 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-4">
                Review and compare different online therapy platforms specializing in depression treatment.
              </p>
              <Button 
                as={Link} 
                to="/compare" 
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-4">
                Discover the top-rated online therapy platforms for depression treatment.
              </p>
              <Button 
                as={Link} 
                to="/best/conditions/best-for-depression" 
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-4">
                Take our depression assessment to understand your symptoms and get personalized recommendations.
              </p>
              <Button 
                as={Link} 
                to="/tools/assessments/depression-assessment" 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <Link to="/learn/fundamentals/depression" className="flex items-center text-indigo-600 hover:text-indigo-800">
                    <ArrowRight className="h-4 w-4 mr-2" />
                    <span>Understanding Depression</span>
                  </Link>
                </li>
                <li>
                  <Link to="/learn/fundamentals/depression-coping-strategies" className="flex items-center text-indigo-600 hover:text-indigo-800">
                    <ArrowRight className="h-4 w-4 mr-2" />
                    <span>Coping Strategies for Depression</span>
                  </Link>
                </li>
                <li>
                  <Link to="/learn/fundamentals/depression-medication-guide" className="flex items-center text-indigo-600 hover:text-indigo-800">
                    <ArrowRight className="h-4 w-4 mr-2" />
                    <span>Guide to Depression Medications</span>
                  </Link>
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <Link to="/resources/worksheets/depression-thought-record" className="flex items-center text-indigo-600 hover:text-indigo-800">
                    <ArrowRight className="h-4 w-4 mr-2" />
                    <span>Depression Thought Record Worksheet</span>
                  </Link>
                </li>
                <li>
                  <Link to="/resources/worksheets/activity-planning" className="flex items-center text-indigo-600 hover:text-indigo-800">
                    <ArrowRight className="h-4 w-4 mr-2" />
                    <span>Activity Planning Worksheet</span>
                  </Link>
                </li>
                <li>
                  <Link to="/resources/support-groups/depression" className="flex items-center text-indigo-600 hover:text-indigo-800">
                    <ArrowRight className="h-4 w-4 mr-2" />
                    <span>Find Depression Support Groups</span>
                  </Link>
                </li>
              </ul>
            </div>
